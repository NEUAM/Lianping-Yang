...
class FACE(data.Dataset):
    def __init__(self, jsonfile, img_folder, inp_res=256, out_res=64, is_train=True, sigma=1,
        ...
        self.inp_res = inp_res  #image size
        self.out_res = out_res  #64 corriding heatmap size
        self.sigma = sigma  #Gauss heat map corresponding variance
        self.scale_factor = scale_factor  #Scaling parameters
        self.rot_factor = rot_factor  #Rotation parameter
